...
namespace SmartSchool.API.Data
{
    public class DataContext : DbContext
    {
        ...
        // criação do relacionamento N:N (Aluno Disciplina)
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, 1, "Lauro", "Oliveira","419986598"),
                    new Professor(2, 2, "Roberto", "Soares","436546598"),
                    new Professor(3, 3, "Ronaldo", "Marconi","449998798"),
                    new Professor(4, 4, "Rodrigo", "Carvalho","459983218"),
                    new Professor(5, 5, "Alexandre", "Montanha","46951998"),
                });
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.Parse("2005-01-17")),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.Parse("2005-03-25")),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.Parse("2005-07-05")),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.Parse("2005-10-22")),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", DateTime.Parse("2005-08-01")),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", DateTime.Parse("2005-09-30")),
                    new Aluno(7, 7, "Paulo", "José", "9874512", DateTime.Parse("2005-01-25"))
                });
